...
// constantes de Shaders de vertices y fragmentos 
...
int main() {
	...
	//variables anteriormente definidas para el tamaño de la ventana
	...
	// Imprimimos informacin de OpenGL del sistema, en la terminal que se muestra al ejecutar el programa
