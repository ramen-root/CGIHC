...
//Se agregan nuevas bibliotecas GLM
#include <glm/glm.hpp>
...
int main() {
 ...
 //     
	...
	//comentar la primera para los segunos vértices y comentar la segunda
...
// Clear buffers
		...
		// Vista y proyección (solo se configuran una vez)
		...
		DrawCube(ourShader, VAO,
			...
			glm::vec3(3.0f, 0.0f, 0.0f),	// rotación (x,y,z) frente, lado, profundo
			0.9f,							// ángulo
		...
		DrawCube(ourShader, VAO,
			...
			glm::vec3(0.0f, 3.0f, 0.0f),	// rotación (lado,alto,)
			0.9f,							// ángulo
		...
		DrawCube(ourShader, VAO,
			...
			glm::vec3(0.0f, 0.0f, 3.0f),	// rotación (lado,alto,)
			0.9f,							// ángulo
			glm::vec3(1.0f),				// escala
			view, projection);


		glBindVertexArray(0); //Esta línea coloca todos los vértices en 0, para limpiar la memoria
		
		/////////////////
		//tres cubos, explicarlo, función para generar cubos
